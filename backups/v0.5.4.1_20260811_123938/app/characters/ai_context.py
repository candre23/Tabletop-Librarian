...
def character_retrieval_query(
    ...
    *,
    ...
    # For indirect questions, include a bounded secondary set of sheet option
    # names so the retriever can discover rules the question does not name.
    if not selected:
        selected.extend(all_hints)
    ...
    return (
        question
        + "\nCharacter sheet terms potentially relevant: "
        + "; ".join(selected)
    )
