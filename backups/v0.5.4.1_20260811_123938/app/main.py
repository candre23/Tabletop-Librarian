    ...
    if not error:
        ...
        try:
            ...
            system_prompt = (
                ...
                "When a question asks how a rule applies to the selected character, perform character-aware rules analysis in three logical steps: "
                "(1) identify only the sheet facts relevant to the question, "
                "(2) identify the applicable rule text with numbered citations, and "
                "(3) state the resulting character-specific conclusion. "
                ...
                "When an answer combines character facts and rules, clearly distinguish what is on the character sheet from what the rules sources say. "
                "For a character-specific rules question, use concise headings when useful: 'Character', 'Rules', and 'Conclusion'. "
                "Under 'Character', report only relevant current sheet facts and never attach numbered citations to them. "
                "Under 'Rules', cite every material rules statement. "
                "Under 'Conclusion', explain the application without introducing any new uncited rule premise. "
                "If the retrieved rules are insufficient for a reliable conclusion, say so instead of filling the gap. "
