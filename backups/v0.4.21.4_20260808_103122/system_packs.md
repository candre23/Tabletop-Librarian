...
Implemented through TTL v0.4.21.3:
...
TTL v0.4.21.3 establishes the default visual language for character-facing
...
Section colors in v0.4.21.3 are automatically alternated by the generic sheet
...
v0.4.21.3 condenses the character header, places advancement actions inside
