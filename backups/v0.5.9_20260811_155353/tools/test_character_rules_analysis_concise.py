...
assert "Lead with the direct answer in the first sentence" in main
assert "Do not list unrelated skills, gear, qualities" in main
assert "few sentences, not with a full character summary" in main
assert "use headings such as 'character', 'rules', and 'conclusion' only" in main.lower()
