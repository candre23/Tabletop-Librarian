...
assert "three internal steps" in main
assert "(1) identify only the sheet facts materially relevant" in main
assert "Do not treat absence from the character sheet as proof" in main
assert "'Character', 'Rules', and 'Conclusion'" in main
assert "Do not list unrelated skills, gear, qualities" in main
