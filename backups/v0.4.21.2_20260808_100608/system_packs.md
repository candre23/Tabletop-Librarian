...
Implemented through TTL v0.4.21.1:
...
TTL v0.4.21.1 establishes the default visual language for character-facing
...
Section colors in v0.4.21.1 are automatically alternated by the generic sheet
...
v0.4.21.1 condenses the character header, places advancement actions inside
