...
from app.ai.answer_verifier import verify_and_revise_answer
...
async def ask_question(request: Request):
    ...
    if not error:
        ...
        try:
            ...
            if reasoning_mode == "advanced":
                update_ai_request_progress(ai_request_id, 74, "Draft answer received")
                update_ai_request_progress(ai_request_id, 79, "Verifying rules and numbers")
                ...
                update_ai_request_progress(ai_request_id, 93, "Verified answer received")
                answer = verified["content"] or draft_answer
                answer_model = verified.get("model") or answer_model
            else:
                answer = draft_answer
