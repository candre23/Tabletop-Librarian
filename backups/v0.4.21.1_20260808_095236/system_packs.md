...
Implemented through TTL v0.4.21:
...
TTL v0.4.21 establishes the default visual language for character-facing
...
Section colors in v0.4.21 are automatically alternated by the generic sheet
...
v0.4.21 condenses the character header, places advancement actions inside
