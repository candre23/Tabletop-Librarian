...
Implemented through TTL v0.4.20:
...
TTL v0.4.20 establishes the default visual language for character-facing
...
Section colors in v0.4.20 are automatically alternated by the generic sheet
...
v0.4.20 condenses the character header, places advancement actions inside
