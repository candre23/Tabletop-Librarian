...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        resumed.data["archetype"] = "Adventurer"
        ...
        # HTTP wizard lifecycle using temporary runtime data directories.
    ...
    paths = {getattr(route_item, "path", None) for route_item in character_web.router.routes}
    expected = {
        "/characters/create/start",
    ...
    print("  multi-step HTTP wizard: OK")
    print("  live calculated values: OK")
