...
Implemented through TTL v0.4.19:
...
TTL v0.4.19 establishes the default visual language for character-facing
...
Section colors in v0.4.19 are automatically alternated by the generic sheet
