...
from app.ai.answer_verifier import AUDITOR_SYSTEM_PROMPT, REVISION_SYSTEM_PROMPT
...
assert '"Revised answer received"' in main
...
assert "speculative" in AUDITOR_SYSTEM_PROMPT
assert "controlling rule" in AUDITOR_SYSTEM_PROMPT
assert "Change only what is necessary" in REVISION_SYSTEM_PROMPT

print("PASS: Advanced verifier + progress checkpoints")
print("  claim-audit verifier present: OK")
