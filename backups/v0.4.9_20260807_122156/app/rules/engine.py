...
class RuleEngine:
    ...
    def validate(self, data: dict[str, Any]) -> list[RuleIssue]:
    ...
    def apply(self, data: dict[str, Any]) -> tuple[dict[str, Any], list[RuleIssue]]:
        values = self.calculate(data)
        return values, self.validate(values)
...
def load_rule_engine(
    ...
    *,
    ...
    known = set(known_fields or set()) | set(calculated)
    ...
    try:
        return RuleEngine(calculated, validation), issues
    except RuleEngineError as exc:
