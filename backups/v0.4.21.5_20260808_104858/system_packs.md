...
Implemented through TTL v0.4.21.4:
...
TTL v0.4.21.4 establishes the default visual language for character-facing
...
Section colors in v0.4.21.4 are automatically alternated by the generic sheet
...
v0.4.21.4 condenses the character header, places advancement actions inside
