...
Future rule categories may include eligibility, effects, and derived
collections.
...
Implemented through TTL v0.4.6:
...
- interactive creation wizard and draft-character lifecycle
- multi-reference/large-collection editor UX
- entity eligibility/effect rules
