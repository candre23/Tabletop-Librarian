...
knowledgebase = (ROOT / "app/templates/admin_knowledgebase.html").read_text()
...
assert 'name="pipeline_preset"' not in ask
assert 'name="pipeline_preset"' in knowledgebase
assert 'Advanced Ask Pipeline Preset' in knowledgebase
...
print("  Advanced preset selector is GM-only on Knowledgebase Tools: OK")
